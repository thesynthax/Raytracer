...
void initializeUniforms(Shader shader) {
   ...
   /* for (int i = 0; i < 9; i++) {
    ...
    shader.setVec3(std::string("u_spheres[").append(std::to_string(0)).append("].mat.color").c_str(), 1, 1, 1);
    ...
    shader.setVec3(std::string("u_spheres[").append(std::to_string(1)).append("].mat.color").c_str(), 0, 1, 0);
    ...
    shader.setVec3(std::string("u_spheres[").append(std::to_string(2)).append("].mat.color").c_str(), 0, 0, 1);
